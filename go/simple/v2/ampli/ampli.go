			...
			EnumSnakeCase(enumSnakeCase EventWithDifferentCasingTypesEnumSnakeCase) interface {
				EnumCamelCase(enumCamelCase EventWithDifferentCasingTypesEnumCamelCase) interface {
					EnumPascalCase(enumPascalCase EventWithDifferentCasingTypesEnumPascalCase) interface {
						PropertyWithSpace(propertyWithSpace string) interface {
							PropertyWithSnakeCase(propertyWithSnakeCase string) interface {
								PropertyWithCamelCase(propertyWithCamelCase string) interface {
									PropertyWithPascalCase(propertyWithPascalCase string) EventWithDifferentCasingTypesBuilder
								}
							}
						}
					}
...
func (b *eventWithDifferentCasingTypesBuilder) PropertyWithSpace(propertyWithSpace string) interface {
	PropertyWithSnakeCase(propertyWithSnakeCase string) interface {
		PropertyWithCamelCase(propertyWithCamelCase string) interface {
			PropertyWithPascalCase(propertyWithPascalCase string) EventWithDifferentCasingTypesBuilder
		}
...
func (b *eventWithDifferentCasingTypesBuilder) PropertyWithPascalCase(propertyWithPascalCase string) EventWithDifferentCasingTypesBuilder {
