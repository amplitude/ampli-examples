...
public enum EventWithDifferentCasingTypesEnumWithSpace {
    ...
    public static EventWithDifferentCasingTypesEnumWithSpace forValue(String value) throws IOException {
        if (value.equals("enum with space")) return ENUM_WITH_SPACE;
        throw new IOException("Cannot deserialize EventWithDifferentCasingTypesEnumWithSpace");
    }
}
