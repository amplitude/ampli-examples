 ...
 *
 * Required dependencies: @amplitude/analytics-node@^0.3.4
...
import { Identify as AmplitudeIdentify } from '@amplitude/analytics-node';
import * as amplitude from '@amplitude/analytics-node';

export type AmplitudeNode = typeof amplitude;
...
export interface LoadOptions {
  ...
  client?: {
    apiKey?: string;
    configuration?: NodeOptions;
    instance?: AmplitudeNode;
  }
}
...
export class Ampli {
  ...
  private amplitude?: AmplitudeNode;

  get client(): AmplitudeNode {
  ...
  setGroup(
    ...
    // TODO: use options.
    return this.amplitude!.setGroup(groupType, groupName);
  }
