...
//
// Required dependencies: com.amplitude:analytics-android:0.1.0-beta.5
...
open class Ampli {
    ...
    open fun load(appContext: android.content.Context, options: LoadOptions? = null) {
        ...
        eventOptions.plan = options?.client?.plan ?: observePlan
    }
    ...
    private fun handleIdentifyEventOptions(overrideUserId: String? = null, options: EventOptions?, overrideOptions: EventOptions?) {
