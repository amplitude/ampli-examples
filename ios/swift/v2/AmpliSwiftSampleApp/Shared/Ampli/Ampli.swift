 ...
 *
 * Required dependencies: https://github.com/amplitude/Amplitude-Swift ~> 0.7.1
...
public class Identify : AmplitudeSwift.Identify {
    ...
    */
    public init(
        ...
        for (property, value) in userProperties.removeNilValues() {
    ...
    */
    public init(
        ...
        super.init(
            ...
            eventProperties: eventProperties.removeNilValues()
        )
    }
...
public class Ampli {
    ...
    public func track(_ event: BaseEvent, options: EventOptions? = nil) -> Void {
        ...
        amplitude?.track(event: event, options: options)
    }

    public func identify(_ userId: String?, _ identify: Identify, options: EventOptions? = nil) -> Void {
        if !isInitializedAndEnabled() {
            return
        }
        ...
        amplitude?.identify(identify: identify, options: eventOptions)
    }
