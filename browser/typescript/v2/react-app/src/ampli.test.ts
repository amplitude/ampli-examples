...
describe('Ampli Browser TS SDK V2 tests', () => {
  ...
  test('should setGroup()', async () => {
    ...
    const response = (await ampli.client.setGroup('Group name', 'Group Value', { user_id: userId })?.promise) as amplitude.Types.Result;
  ...
  test('should groupIdentify()', async () => {
    ...
    const response = (await ampli.client.groupIdentify('Group name', 'Group Value', amplitudeIdentify, { user_id: userId })?.promise) as amplitude.Types.Result;
