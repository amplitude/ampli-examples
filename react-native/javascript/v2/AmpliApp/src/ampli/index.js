 ...
 * To update run 'ampli pull react-native-js-ampli-v2'
 *
 * Required dependencies: @amplitude/analytics-react-native@^0.3.0 @react-native-async-storage/async-storage@^1.17.9
 * Tracking Plan Version: 0
 * Build: 1.0.0
 * Runtime: react-native:javascript-ampli-v2
 *
 * [View Tracking Plan](https://data.amplitude.com/test-codegen/Test%20Codegen/events/main/latest)
 *
 * [Full Setup Instructions](https://data.amplitude.com/test-codegen/Test%20Codegen/implementation/react-native-js-ampli-v2)
 */
 ...
 * @property {ReactNativeClient} [instance]
 */
...
export class Ampli {
  constructor() {
    /* @type {ReactNativeClient|undefined} */
