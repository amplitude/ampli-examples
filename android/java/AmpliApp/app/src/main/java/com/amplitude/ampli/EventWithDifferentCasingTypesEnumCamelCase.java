...
public enum EventWithDifferentCasingTypesEnumCamelCase {
    ...
    public String toValue() {
        switch (this) {
            case ENUM_CAMEL_CASE: return "enumCamelCase";
        }
        return null;
    }

    public static EventWithDifferentCasingTypesEnumCamelCase forValue(String value) throws IOException {
        if (value.equals("enumCamelCase")) return ENUM_CAMEL_CASE;
        throw new IOException("Cannot deserialize EventWithDifferentCasingTypesEnumCamelCase");
    }
}
